          ...
          <div class="row">
              ...
              <div class="card-blog">
                ...
                <div class="body">
                  ...
                  <div class="site-info">
                    <div class="avatar mr-2">
                      <div class="avatar-img">
                        <img src="{{asset('img/person/person_4.jpg')}}" alt="">
                      </div>
            ...
            <div class="col-sm-6 py-3">
              <div class="card-blog">
                <div class="header">
                  <div class="post-category">
                    <a href="{{asset('#')}}">Neurology</a>
                  </div>
                  <a href="blog-details" class="post-thumb">
                    <img src="{{asset('img/blog/blog_4.jpg')}}" alt="">
                  </a>
                </div>
                <div class="body">
            ...
            <div class="col-sm-6 py-3">
              <div class="card-blog">
                <div class="header">
                  <div class="post-category">
                    <a href="{{asset('#')}}">Cardiology</a>
                  </div>
                  <a href="blog-details" class="post-thumb">
                    <img src="{{asset('img/blog/blog_5.jpg')}}" alt="">
                  </a>
                </div>
                <div class="body">
            ...
            <div class="col-sm-6 py-3">
              <div class="card-blog">
                <div class="header">
                  <div class="post-category">
                    <a href="{{asset('#')}}">Patient Services</a>
                  </div>
                  <a href="blog-details" class="post-thumb">
                    <img src="{{asset('img/blog/blog_1.jpg')}}" alt="">
                  </a>
              ...
              <nav aria-label="Page Navigation">
                <ul class="pagination justify-content-center">
                  <li class="page-item disabled">
                    <a class="page-link" href="{{asset('#')}}" tabindex="-1" aria-disabled="true">Previous</a>
                  </li>
                  <li class="page-item active" aria-current="page">
                    <a class="page-link" href="{{asset('#')}}">1 <span class="sr-only">(current)</span></a>
                  </li>
                  <li class="page-item">
                    <a class="page-link" href="{{asset('#')}}">2</a>
                  </li>
                  <li class="page-item"><a class="page-link" href="{{asset('#')}}">3</a></li>
                  <li class="page-item">
                    <a class="page-link" href="{{asset('#')}}">Next</a>
                  </li>
                </ul>
              </nav>
            </div>
        ...
        <div class="col-lg-4">
          <div class="sidebar">
            <div class="sidebar-block">
              ...
              <form action="{{asset('#')}}" class="search-form">
            ...
            <div class="sidebar-block">
              ...
              <div class="blog-item">
                ...
                <div class="content">
                  <h5 class="post-title"><a href="{{asset('#')}}">Even the all-powerful Pointing has no control</a></h5>
                  <div class="meta">
                    <a href="{{asset('#')}}"><span class="mai-calendar"></span> July 12, 2018</a>
                    <a href="{{asset('#')}}"><span class="mai-person"></span> Admin</a>
                    <a href="{{asset('#')}}"><span class="mai-chatbubbles"></span> 19</a>
                  </div>
                </div>
              </div>
              <div class="blog-item">
