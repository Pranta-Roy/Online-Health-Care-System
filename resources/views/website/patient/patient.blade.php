...
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="{{asset('#')}}"><span class="mai-call text-primary"></span> +088 01643176947</a>
              <span class="divider">|</span>
              <a href="{{asset('#')}}"><span class="mai-mail text-primary"></span> mail@one-health.com</a>
              
            </div>
            <h5 class="patient-head">Patient Page</h5>
          </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          ...
          <a href="/index">
          <button class="btn btn-primary" type="button" style="color:white;">Log out</button>
          </a>
        </div> <!-- .navbar-collapse -->
      </div> <!-- .container -->
    </nav>
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url('{{asset('img/bg_image_1.jpg')}}');">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        ...
        <a href="{{asset('#')}}" class="btn btn-primary">Let's Consult</a>
      </div>
    </div>
  </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 py-3 wow fadeInUp">
            ...
            <a href="{{asset('about.html')}}" class="btn btn-primary">Learn More</a>
          </div>
        ...
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              ...
              <div class="meta">
                <a href="{{asset('#')}}"><span class="mai-call"></span></a>
                <a href="{{asset('#')}}"><span class="mai-logo-whatsapp"></span></a>
              </div>
            </div>
            <div class="body">
      ...
      <div class="row mt-5">
        <div class="col-lg-4 py-2 wow zoomIn">
          <div class="card-blog">
            <div class="header">
              ...
              <a href="{{asset('blog-details.html')}}" class="post-thumb">
                <img src="{{asset('img/blog/blog_1.jpg')}}" alt="">
              </a>
            </div>
            <div class="body">
              <h5 class="post-title"><a href="{{asset('blog-details.html')}}">List of Countries without Coronavirus case</a></h5>
              <div class="site-info">
        ...
        <div class="col-lg-4 py-2 wow zoomIn">
          <div class="card-blog">
            <div class="header">
              <div class="post-category">
                <a href="{{asset('#')}}">Covid19</a>
              </div>
              <a href="{{asset('blog-details.html')}}" class="post-thumb">
                <img src="{{asset('img/blog/blog_2.jpg')}}" alt="">
              </a>
            </div>
            <div class="body">
              <h5 class="post-title"><a href="{{asset('blog-details.html')}}">Recovery Room: News beyond the pandemic</a></h5>
              <div class="site-info">
                <div class="avatar mr-2">
                  <div class="avatar-img">
                    <img src="{{asset('img/person/person_1.jpg')}}" alt="">
        ...
        <div class="col-lg-4 py-2 wow zoomIn">
          <div class="card-blog">
            <div class="header">
              ...
              <a href="{{asset('blog-details.html')}}" class="post-thumb">
                <img src="{{asset('img/blog/blog_3.jpg')}}" alt="">
              </a>
            </div>
            <div class="body">
              <h5 class="post-title"><a href="{{asset('blog-details.html')}}">What is the impact of eating too much sugar?</a></h5>
              <div class="site-info">
                <div class="avatar mr-2">
                  <div class="avatar-img">
        ...
        <div class="col-12 text-center mt-4 wow zoomIn">
          <a href="{{asset('blog.html')}}" class="btn btn-primary">Read More</a>
        </div>
    ...
    <div class="container py-5 py-lg-0">
      <div class="row align-items-center">
        ...
        <div class="col-lg-8 wow fadeInRight">
          ...
          <a href="{{asset('#')}}"><img src="{{asset('img/google_play.svg')}}" alt=""></a>
          <a href="{{asset('#')}}" class="ml-2"><img src="{{asset('img/app_store.svg')}}" alt=""></a>
        </div>
      </div>
    </div>
  </div> <!-- .banner-home -->
  ...
  <footer class="page-footer">
    <div class="container">
      ...
      <p id="copyright">Copyright &copy; 2022 <a href="https://macodeid.com/" target="_blank">>KOWSHICK-PRANTO-SARFARAJ-ADITI</a>. All right reserved</p>
    </div>
  </footer>
